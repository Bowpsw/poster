...
<input type="button" value="เพิ่มสินค้า"onclick="window.location.href='${pageContext.request.contextPath}/owner/${owner.id}/product/add';return false;"class="add-button"/>
<table class="table-bordered">
  ...
  <tbody><c:forEach var="product" items="${products}">
    <tr>
      ...
      <td>${product.name}</td>
      <td>${product.price}</td>
      <td class="center"><a href="${pageContext.request.contextPath}/owner/${owner.id}/product/${product.id}/remove">ลบ</a></td>
    </tr>
  </c:forEach></tbody>
</table>
</div>
